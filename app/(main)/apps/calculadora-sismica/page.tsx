...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    title: 'Calculadora Sísmica E.030 Perú',
    description: 'Calcula la fuerza cortante basal según la norma E.030. Herramienta gratuita para ingenieros.',
  }
};

export default function CalculadoraSismicaPage() {
  const schema = generateSoftwareApplicationSchema({
    name: 'Calculadora Sísmica E.030',
    description: 'Calcula la fuerza cortante basal y el coeficiente sísmico según la norma E.030 de diseño sismorresistente del Perú.',
    applicationCategory: 'EngineeringApplication',
    url: 'https://freecloud.pe/apps/calculadora-sismica',
    price: '0',
    currency: 'PEN'
  });
