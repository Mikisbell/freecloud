        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://youtube.com/@mikisbell" target="_blank" rel="noopener" className="w-9 h-9 bg-surface-800 hover:bg-teal-600 rounded-lg flex items-center justify-center transition-colors">
                <Youtube className="w-4 h-4" />
              </a>
              <a href="mailto:contacto@freecloud.pe" target="_blank" rel="noopener" className="w-9 h-9 bg-surface-800 hover:bg-teal-600 rounded-lg flex items-center justify-center transition-colors">
